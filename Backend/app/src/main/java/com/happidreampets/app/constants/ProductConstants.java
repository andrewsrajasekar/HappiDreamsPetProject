package com.happidreampets.app.constants;
...
public class ProductConstants {
    ...
    public class MessageCase {
        public static final String THE_VALUE_SHOULD_BE_AN_INTEGER = "The value should be an integer";
        public static final String THE_VALUE_SHOULD_BE_AN_ARRAY_OF_INTEGERS = "The value should be an array of integers";
    ...
    public class ExceptionMessageCase {
        ...
        public static final String STOCKS_CANNOT_BE_EMPTY = "Stocks cannot be empty";
        public static final String PRICE_CANNOT_BE_EMPTY = "Price cannot be empty";
    ...
    public class OtherCase {
        public static final String USER_DOT_DIR = "user.dir";
    }
