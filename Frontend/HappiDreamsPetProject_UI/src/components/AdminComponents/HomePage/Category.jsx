...
/>
        ...
        <div>
            {categorySampleProducts.length > 0 && 
                    <HomeCategorySampleProducts key={JSON.stringify(categorySampleProducts)} categorySampleProducts={categorySampleProducts} handleDeleteSection={deleteSection} handleEditSection={editSection} showManipulateButtons={true} />
            }
        </div>     
         </div>
    )
