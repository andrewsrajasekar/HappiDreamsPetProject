...
import { isUserLoggedIn } from "../services/SessionDetails";

function NavBar() {
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);
  const [isLogInDone, setIsLogInDone] = useState();

  useEffect(() => {
    setIsLogInDone(isUserLoggedIn());
  }, [])
  ...
  const goToLogin = () => {
    navigate("/login",{state:{resetPage: true}});
  }
